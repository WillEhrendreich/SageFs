          ...
          [
              ...
              Elem.div [ Attr.class' "flex-row"; Attr.style "gap: 0.5rem; flex-wrap: wrap;" ] [
                ...
                | app ->
                  let color =
                    ...
                    | AppRun.AppRunState.Crashed _ | AppRun.AppRunState.BuildFailed _ -> "var(--fg-red)"
                    | _ -> "var(--fg-dim)"
                  Elem.div
            ...
            Elem.div [ Attr.class' "session-card-actions" ] [
              ...
              let runTitle (name: string) =
                match s.App with
                | AppRun.AppRunState.Exited _ | AppRun.AppRunState.Crashed _ | AppRun.AppRunState.BuildFailed _ ->
