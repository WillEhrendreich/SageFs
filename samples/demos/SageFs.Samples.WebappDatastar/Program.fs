...
//    Falco, Falco.Markup, Falco.Datastar

module SageFs.Samples.WebappDatastar.Program
...
// NOTE: SageFs.DevReloadMiddleware is omitted here since this is a
// standalone demo project. When run under SageFs, the middleware is
// injected automatically for live browser hot-reload.
[<EntryPoint>]
let main args =
